...
the two-channel verdict over one channel and the transitive union-find trap,
the withheld count as a defect, the asymmetric size limit, and the wrong-axis
remedy for JSON indexing.
